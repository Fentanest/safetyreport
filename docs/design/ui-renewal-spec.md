...
## 2. 디자인 방향 (시안에서 읽은 것)
- 다크(2026-09-25 개정): B안 "딥 다크" — 채도 거의 없는 검정 계단 바탕·패널·경계, 파랑은 글자·아이콘 강조(`#60a5fa`)와 흰 글자 채움(`#2563eb`)에만. 값과 모바일 대응은 `docs/design/dark-palette.md`. (예전: 다크: 깊은 네이비 배경, 한 단계 밝은 네이비 패널, 얇은 파랑 경계, 파랑/시안 강조. 선택된 탭·주요 버튼만 채움 파랑.)
