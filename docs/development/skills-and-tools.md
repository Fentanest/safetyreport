...
| Playwright Test | `@playwright/test` 1.63.0 (microsoft/playwright) | `tools/web-tests` devDependency, `package-lock.json` 고정 | `specs/fixture-smoke.spec.ts` chromium+firefox | 10/10 통과. WebKit 은 호스트 라이브러리 부족(blocked) |
